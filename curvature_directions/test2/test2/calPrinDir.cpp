...
//        {
//            int index = faceList[i][xxx][0];
//            asctodo.Vertex[xxx][0] = verticesList[index][0];
//            asctodo.Vertex[xxx][1] = verticesList[index][1];
//            asctodo.Vertex[xxx][2] = verticesList[index][2];
//            /**/
//            pd[xxx][0][0] = dir1[index][0];
//            pd[xxx][0][1] = dir1[index][1];
//            pd[xxx][0][2] = dir1[index][2];
//            pd[xxx][1][0] = dir2[index][0];
//            pd[xxx][1][1] = dir2[index][1];
//            pd[xxx][1][2] = dir2[index][2];
//            //pd[xxx][0][0] = 0;
//            //pd[xxx][0][1] = 0;
//            //pd[xxx][0][2] = 1;
//            //pd[xxx][1][0] = 0;
...
//            //pd[xxx][1][2] = 1;
//            /****/
//            index = faceList[i][xxx][1];
//            asctodo.Normal[xxx][0] = normList[index][0];
//            asctodo.Normal[xxx][1] = normList[index][1];
//            asctodo.Normal[xxx][2] = normList[index][2];
//            /****/
//            asctodo.Texture[xxx][0] = 0;
//            asctodo.Texture[xxx][1] = 0;
//        }
