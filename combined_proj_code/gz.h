...
#define GZ_MAJOR_CUVATURE_DIRECTION 4
#define GZ_MINOR_CUVATURE_DIRECTION 5
...
#define	DEFAULT_IM_X	(-10.0)
        ...
        position[X] = DEFAULT_IM_X;
        position[Y] = DEFAULT_IM_Y;
        position[Z] = DEFAULT_IM_Z;
